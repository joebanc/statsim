...
class __declspec(dllexport) _tochar {
private:
  BOOL m_bAutoDelete;
  LPSTR m_szBuffer;
...
class __declspec(dllexport) _towchar {
private:
  BOOL m_bAutoDelete;
  LPWSTR m_wszBuffer;
...
class __declspec(dllexport) _totchar {
private:
  BOOL m_bAutoDelete;
  LPTSTR m_tszBuffer;
...
class __declspec(dllexport) _cochar {
private:
  BOOL m_bAutoDelete;
  LPSTR m_szBuffer;
...
class __declspec(dllexport) _cowchar {
private:
  BOOL m_bAutoDelete;
  LPWSTR m_wszBuffer;
...
class __declspec(dllexport) _cotchar {
private:
  BOOL m_bAutoDelete;
  LPTSTR m_tszBuffer;
