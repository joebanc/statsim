...
int extcongov01()
{
	...
	ofstream output("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2001_gov_cong_dat.txt", ofstream::binary);

	multimap<string,int> words;
	map<int,string> lines;
	string str;
	ifstream input("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2001_gov_cong.txt");
	if(input.fail())
	{
	...
	string search, search0("PRINTED: 11/7/06"), search1("PROVINCE: "), search2("CITY OF "), 
		search3("CONGRESSMAN"), search4("PROVINCIAL GOVERNOR"),
		search5("PROVINCIAL VICE-GOVERNOR"), search6("PROVINCIAL BOARD MEMBER"), search7("2001");
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										if( (str.find(",2002")!=string::npos ||str.find(",2003")!=string::npos ||str.find(",2001")!=string::npos || str.find(",2008")!=string::npos
											|| str.find(", 2001")!=string::npos || str.find(",2001")!=string::npos 
