...
int extloc04()
{
	...
	ofstream output("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2004_local_dat.txt", ofstream::binary);

	multimap<string,int> words;
	map<int,string> lines;
	string str;
	ifstream input("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2004_local.txt");
	if(input.fail())
	{
	...
	string search, search0("Republic of the Philippines"), search1("PROVINCE :"), search2("CITY/MUN :"), 
		...
		search5("COUNCILOR"), search6(" DISTRICT"), search7("2004");
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										if( (str.find(",2004")!=string::npos || str.find(", 2004")!=string::npos || str.find(",2005")!=string::npos || str.find("No date of ")!=string::npos
