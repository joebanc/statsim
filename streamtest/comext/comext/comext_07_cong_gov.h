...
int extcongov07()
{
	...
	ofstream output("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2007_gov_cong_dat.txt", ofstream::binary);

	multimap<string,int> words;
	map<int,string> lines;
	string str;
	ifstream input("X:\\Documents\\AIM\\democracy\\comelec data\\data\\2007_gov_cong.txt");
	if(input.fail())
	{
	...
	string search, search0("PRINTED: 05/15/09"), search1("PROVINCE :"), search2("CITY OF"), 
		search3("MEMBER, HOUSE OF REPRESENTATIVE"), search4("PROVINCIAL GOVERNOR"),
		search5("PROVINCIAL VICE-GOVERNOR"), search6("PROVINCIAL BOARD MEMBER"), search7("2007");
					...
					else
					{
						...
						else
						{
							...
							else
							{
								...
								{
									if(str.find("May 14, 2007 National and Local Elections")!=string::npos ||
										...
										str.find("M a n i l a")!=string::npos ||
										str.find("REGION")!=string::npos ||
										str.find("OFFICE/DISTRICT/")!=string::npos ||
										str.find("NAME OF CANDIDATE")!=string::npos ||
										...
										str.find("PROCLAMATION REMARKS")!=string::npos )
									{
										continue;
									}
									else
